...
#MODEL_DIR = os.path.join(ROOT_DIR, "hole_logs/project_4") ##########最新權重檔的資料夾
...
def gt_pred_lists(gt_class_ids, gt_bboxes, pred_class_ids, pred_bboxes, iou_tresh = 0.3):
...
def plot_confusion_matrix_from_data(y_test, predictions, columns=None, annot=True, cmap="Oranges",
    ...
    pretty_plot_confusion_matrix(df_cm.T, fz=fz, cmap=cmap, figsize=figsize, show_null_values=show_null_values, 
...
for image_id in dataset_val.image_ids:
    ...
    gt, pred = gt_pred_lists(gt_class_id, gt_bbox, r['class_ids'], r['rois'], iou_tresh = 0.3)
...
tp,fp,fn=plot_confusion_matrix_from_data(gt_tot,pred_tot,fz=18, figsize=(10,10), lw=0.5)
